...
const parse_proxy_response_1 = __nccwpck_require__(9761);
...
const parseOptions = __nccwpck_require__(9855)
const { safeRe: re, t } = __nccwpck_require__(6754)
const cmp = __nccwpck_require__(3839)
const debug = __nccwpck_require__(3958)
const SemVer = __nccwpck_require__(6114)
const Range = __nccwpck_require__(7877)
...
const LRU = __nccwpck_require__(4255)
const cache = new LRU()

const parseOptions = __nccwpck_require__(9855)
const Comparator = __nccwpck_require__(1627)
const debug = __nccwpck_require__(3958)
const SemVer = __nccwpck_require__(6114)
const {
  safeRe: re,
...
const { FLAG_INCLUDE_PRERELEASE, FLAG_LOOSE } = __nccwpck_require__(2646)
...
const debug = __nccwpck_require__(3958)
const { MAX_LENGTH, MAX_SAFE_INTEGER } = __nccwpck_require__(2646)
const { safeRe: re, t } = __nccwpck_require__(6754)

const parseOptions = __nccwpck_require__(9855)
const { compareIdentifiers } = __nccwpck_require__(2576)
class SemVer {
...
const parse = __nccwpck_require__(3038)
...
const eq = __nccwpck_require__(2162)
const neq = __nccwpck_require__(1790)
const gt = __nccwpck_require__(2220)
const gte = __nccwpck_require__(3102)
const lt = __nccwpck_require__(7226)
const lte = __nccwpck_require__(1164)
...
const compare = __nccwpck_require__(7677)
...
const compareBuild = __nccwpck_require__(3980)
...
const internalRe = __nccwpck_require__(6754)
const constants = __nccwpck_require__(2646)
const SemVer = __nccwpck_require__(6114)
const identifiers = __nccwpck_require__(2576)
const parse = __nccwpck_require__(3038)
const valid = __nccwpck_require__(8416)
const clean = __nccwpck_require__(3647)
const inc = __nccwpck_require__(2502)
const diff = __nccwpck_require__(7774)
const major = __nccwpck_require__(6170)
const minor = __nccwpck_require__(4893)
const patch = __nccwpck_require__(8879)
const prerelease = __nccwpck_require__(7378)
const compare = __nccwpck_require__(7677)
const rcompare = __nccwpck_require__(9235)
const compareLoose = __nccwpck_require__(9485)
const compareBuild = __nccwpck_require__(3980)
const sort = __nccwpck_require__(8063)
const rsort = __nccwpck_require__(3103)
const gt = __nccwpck_require__(2220)
const lt = __nccwpck_require__(7226)
const eq = __nccwpck_require__(2162)
const neq = __nccwpck_require__(1790)
...
const lte = __nccwpck_require__(1164)
const cmp = __nccwpck_require__(3839)
const coerce = __nccwpck_require__(6954)
const Comparator = __nccwpck_require__(1627)
const Range = __nccwpck_require__(7877)
const satisfies = __nccwpck_require__(780)
const toComparators = __nccwpck_require__(5296)
const maxSatisfying = __nccwpck_require__(9243)
const minSatisfying = __nccwpck_require__(3391)
const minVersion = __nccwpck_require__(7664)
const validRange = __nccwpck_require__(7)
const outside = __nccwpck_require__(8590)
const gtr = __nccwpck_require__(8651)
const ltr = __nccwpck_require__(1707)
const intersects = __nccwpck_require__(7077)
const simplifyRange = __nccwpck_require__(7049)
const subset = __nccwpck_require__(149)
module.exports = {
  parse,
  valid,
  clean,
...
const os_1 = __nccwpck_require__(2037);
const path = __importStar(__nccwpck_require__(1017));
const semver = __importStar(__nccwpck_require__(7396));
...
const makeConsoleReporter = async () => {
    ...
    const { default: ora } = await __nccwpck_require__.e(/* import() */ 606).then(__nccwpck_require__.bind(__nccwpck_require__, 2606));
    let version;
...
const https_proxy_agent_1 = __nccwpck_require__(7910);
const path = __importStar(__nccwpck_require__(1017));
const url_1 = __nccwpck_require__(7310);
const download_1 = __nccwpck_require__(9509);
const request = __importStar(__nccwpck_require__(729));
...
const agent_base_1 = __nccwpck_require__(4247);
const url_1 = __nccwpck_require__(7310);
...
__exportStar(__nccwpck_require__(1073), exports);
const INTERNAL = Symbol('AgentBaseInternalState');
class Agent extends http.Agent {
    constructor(opts) {
        super(opts);
...
/* harmony import */ var execa__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(9884);
/* harmony import */ var _vscode_test_electron__WEBPACK_IMPORTED_MODULE_2__ = __nccwpck_require__(5140);
/* harmony import */ var _vscode_test_electron__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__nccwpck_require__.n(_vscode_test_electron__WEBPACK_IMPORTED_MODULE_2__);
...
const run = async () => {
     ...
     */
    const machineId = ((0,_actions_core__WEBPACK_IMPORTED_MODULE_3__.getInput)('machineName')
     ...
     */
    const timeout = (parseInt((0,_actions_core__WEBPACK_IMPORTED_MODULE_3__.getInput)('timeout'), 10)
        || 30 * 1000 // default 30s
    );
    /**
     * download latest VS Code
     */
    const vscodePath = await (0,_vscode_test_electron__WEBPACK_IMPORTED_MODULE_2__.download)({ version: 'stable' });
    const codePath = (0,_vscode_test_electron__WEBPACK_IMPORTED_MODULE_2__.resolveCliPathFromVSCodeExecutablePath)(vscodePath);
    ...
    console.log(6);
    await (0,execa__WEBPACK_IMPORTED_MODULE_1__/* .execa */ .r)(codePath, ['tunnel', '--accept-server-license-terms'], {
